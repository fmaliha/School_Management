<%@ Page Title="" Language="C#" MasterPageFile="~/InvexiaMaster.Master" AutoEventWireup="true" CodeBehind="ApparelEnterpriseFutureMarketing.aspx.cs" Inherits="InovexiaEBS.ApparelEnterprise.ApparelEnterpriseFutureMarketing" %>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enterprise Future Marketing</h3>
                        </div>
                                    ...
                                    <div class="col-sm-6 eq-box-sm">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                         <asp:HiddenField ID="hidEnterpriseFutureMarketID" runat="server" />
                                                   ...
                                                   <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Item Description </label>
                                                             <span style="color: red;">*</span>
                                                            <asp:RequiredFieldValidator ID="rfvItemDescription" ControlToValidate="txtItemDescription" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Expected Amount  </label>
                                                             <span style="color: red;">*</span>
                                                            <asp:RequiredFieldValidator ID="rfvAmount" ControlToValidate="txtAmount" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>
                                                          
                                                          
                                                              <asp:TextBox ID="txtAmount" runat="server" onkeyup="checkDec(this);" class="form-control" ></asp:TextBox>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <telerik:RadGrid ID="grdDetails" runat="server" CellSpacing="0" GridLines="None" Height="100%" Skin="Silk" OnNeedDataSource="grdDetails_NeedDataSource" Width="100%"
                                    ...
                                    <MasterTableView DataKeyNames="EnterpriseFutureMarketID">
                                        <Columns>
