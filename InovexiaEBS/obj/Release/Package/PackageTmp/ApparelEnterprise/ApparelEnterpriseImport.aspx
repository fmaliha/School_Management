<%@ Page Title="" Language="C#" MasterPageFile="~/InvexiaMaster.Master" AutoEventWireup="true" CodeBehind="ApparelEnterpriseImport.aspx.cs" Inherits="InovexiaEBS.ApparelEnterprise.ApparelEnterpriseImport" %>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enterprise Import</h3>
                        </div>
                                    ...
                                    <div class="col-sm-6 eq-box-sm">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <asp:HiddenField ID="hidEnterPriseImport" runat="server" />
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span style="color: red;">*</span>
                                                            <asp:RequiredFieldValidator ID="rfvImportType" ControlToValidate="ddlImportType" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>
                                                            <telerik:RadComboBox ID="ddlImportType" runat="server"
                                                                DropDownCssClass="widthClass"
                                                                EmptyMessage="Select Import Type" EnableLoadOnDemand="True" Filter="Contains"
                                                                Height="200px" HighlightTemplatedItems="True"
                                                                Width="100%"
                                                                OnItemsRequested="ddlImportType_ItemsRequested"
                                                                Skin="Silk" Style="background-color: #339966;" AutoPostBack="true">
                                                                <HeaderTemplate>
                                                                    <table cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                ...
                                                                <ItemTemplate>
                                                                    <table cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            ...
                                                                            <td><%# DataBinder.Eval(Container, "Attributes['ImportTypeName']")%></td>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span style="color: red;">*</span>
                                                            <asp:RequiredFieldValidator ID="rfvtxtItemDescription" ControlToValidate="txtItemDescription" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>

                                                            <asp:TextBox ID="txtItemDescription" runat="server" class="form-control"></asp:TextBox>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtTotalValue" runat="server" onkeyup="checkDec(this);" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enterprise Import List</h3>
                        </div>
                        <div class="panel-body">


                            <div class="row">
                                <telerik:RadGrid ID="grdYarnEnterpriseImport" runat="server" CellSpacing="0" GridLines="None" Height="100%" Skin="Silk" OnNeedDataSource="grdYarnEnterpriseImport_NeedDataSource" Width="100%"
                                    AllowPaging="true"
                                    AllowFilteringByColumn="True" PageSize="10">
                                    <ClientSettings>
                                        <%--  <Scrolling AllowScroll="True" />--%>
                                    </ClientSettings>
                                    <MasterTableView DataKeyNames="EnterpriseImportID">
                                        <Columns>
