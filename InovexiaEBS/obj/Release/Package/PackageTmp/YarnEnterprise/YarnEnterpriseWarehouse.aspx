<%@ Page Title="" Language="C#" MasterPageFile="~/InvexiaMaster.Master" AutoEventWireup="true" CodeBehind="YarnEnterpriseWarehouse.aspx.cs" Inherits="InovexiaEBS.YarnEnterprise.YarnEnterpriseWarehouse" %>
...
<script language="javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hidEnterpriseWarehouseID" runat="server" />
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enterprise Warehouse</h3>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span style="color: red;">*</span>
                                                            <asp:RequiredFieldValidator ID="rfvCapacity" ControlToValidate="txtCapacity" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>

                                                            <asp:TextBox ID="txtCapacity" runat="server" onkeypress="return isNumberKey(event)" class="form-control"></asp:TextBox>
                                                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <telerik:RadGrid ID="grdDetails" runat="server" CellSpacing="0" GridLines="None" Height="100%" Skin="Silk" OnNeedDataSource="grdDetails_NeedDataSource" Width="100%"
                                    ...
                                    <MasterTableView DataKeyNames="EnterpriseWarehouseID">
                                        <Columns>
