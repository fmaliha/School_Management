<%@ Page Title="" Language="C#" MasterPageFile="~/InvexiaMaster.Master" AutoEventWireup="true" CodeBehind="YarnEnterpriseCompliance.aspx.cs" Inherits="InovexiaEBS.YarnEnterprise.YarnEnterpriseCompliance" %>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span style="color: red;">*</span>
                                                            <asp:RequiredFieldValidator ID="rfvComplianceType" ControlToValidate="ddlComplianceType" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Effective From</label>                                                            
                                                             <telerik:RadComboBox ID="ddlEffectFromYear" runat="server"
                                                                DropDownCssClass="widthClass"
                                                                Width="100%"
                                                                EmptyMessage="Select Compliance Type" EnableLoadOnDemand="True" Filter="Contains"
                                                                Height="200px" HighlightTemplatedItems="True"
                                                                OnItemsRequested="ddlEffectFromYear_ItemsRequested" 
                                                                Skin="Silk" Style="background-color: #339966;" AutoPostBack="true">
                                                                <HeaderTemplate>
                                                                    <table cellpadding="0" cellspacing="0" >
                                                                        <tr>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <telerik:RadGrid ID="grdEnterpriseCompliance"   runat="server" CellSpacing="0" GridLines="None" Height="100%" Skin="Silk" OnNeedDataSource="grdInstitutionPrograms_NeedDataSource" Width="100%"
                                    AllowPaging="true"
                                    AllowFilteringByColumn="True" PageSize="5" >
                                    <ClientSettings>
                                       <%--   <Scrolling AllowScroll="True" />--%>
                                    </ClientSettings>
                                    <MasterTableView DataKeyNames="EnterpriseComplianceID">
                                        <Columns>
