<%@ Page Title="" Language="C#" MasterPageFile="~/InvexiaMaster.Master" AutoEventWireup="true" CodeBehind="YarnEnterpriseEntry.aspx.cs" Inherits="InovexiaEBS.YarnEnterprise.YarnEnterpriseEntry" %>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Yarn Enterprise Management</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtEnterpriseCode" runat="server" class="form-control" AutoPostBack="true" ></asp:TextBox>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <span style="color: red;">*</span>
                                        <asp:RequiredFieldValidator ID="rfvEstablishedYear" ControlToValidate="dtpEstablishedDate" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>
                                       

                                        <telerik:RadDatePicker ID="dtpEstablishedDate" runat="server" DateInput-DateFormat="M/d/yyyy" DateInput-DisplayDateFormat="d/M/yyyy"></telerik:RadDatePicker>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <span style="color: red;">*</span>
                                        <asp:RequiredFieldValidator ID="rfvOwnersContact" ControlToValidate="txtOwnersContact" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enterprise Management</h3>
                        </div>
                        <div class="panel-body">


                            <div class="row">
                                <telerik:RadGrid ID="grdEnterpriseManagement" runat="server" CellSpacing="0" GridLines="None" Height="100%" Skin="Silk" OnNeedDataSource="grdEnterpriseManagement_NeedDataSource" Width="100%"
                                    AllowPaging="True"
