<%@ Page Title="" Language="C#" MasterPageFile="~/InvexiaMaster.Master" AutoEventWireup="true" CodeBehind="YarnEnterpriseMarketStatus.aspx.cs" Inherits="InovexiaEBS.YarnEnterprise.YarnEnterpriseMarketStatus" %>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enterprise Market Status</h3>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span style="color: red;">*</span>
                                                            <asp:RequiredFieldValidator ID="rfvSalesAmount" ControlToValidate="txtSalesAmount" ValidationGroup="MasterValidation" runat="server" ForeColor="Red" ErrorMessage="(Required)"></asp:RequiredFieldValidator>

                                                            <asp:TextBox ID="txtSalesAmount" runat="server" onkeypress="return isNumberKey(event)" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <telerik:RadComboBox ID="ddlMeasurementUnit" runat="server"
                                                                DropDownCssClass="widthClass"
                                                                EmptyMessage="Select  Unit" EnableLoadOnDemand="True" Filter="Contains"
                                                                Height="200px" HighlightTemplatedItems="True"
                                                                Width="100%"
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Yarn Enterprise Compliance</h3>
                        </div>
                        <div class="panel-body">


                            <div class="row">
                                <telerik:RadGrid ID="grdEnterpriseMarketStatus"   runat="server" CellSpacing="0" GridLines="None" Height="100%" Skin="Silk" OnNeedDataSource="grdInstitutionPrograms_NeedDataSource" Width="100%"
                                    AllowPaging="true"
                                    AllowFilteringByColumn="True" PageSize="5" >
                                    <ClientSettings>
                                       <%--   <Scrolling AllowScroll="True" />--%>
                                    </ClientSettings>
                                    <MasterTableView DataKeyNames="EnterpriseMarketStatusID">
                                        <Columns>
