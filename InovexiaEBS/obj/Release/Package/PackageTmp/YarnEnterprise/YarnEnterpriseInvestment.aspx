<%@ Page Title="" Language="C#" MasterPageFile="~/InvexiaMaster.Master" AutoEventWireup="true" CodeBehind="YarnEnterpriseInvestment.aspx.cs" Inherits="InovexiaEBS.YarnEnterprise.YarnEnterpriseInvestment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="hidEnterpriseInvestmentID" runat="server" />
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enterprise Investment Creation</h3>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enterprise Investment List</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <telerik:RadGrid ID="grdDetails" runat="server" CellSpacing="0" GridLines="None" Height="100%" Skin="Silk" OnNeedDataSource="grdDetails_NeedDataSource" Width="100%"
                                    ...
                                    <MasterTableView DataKeyNames="EnterpriseInvestmentID">
                                        <Columns>
